...
public class ExceptionDemo2{
	...
	//means the one who calls me will handle the exception so in main whoever will call will handle exception
	public static void parseStringtoDate(String s) throws ParseException {
